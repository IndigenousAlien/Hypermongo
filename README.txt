...
In its simplest form, Hypermongo reads data files with columns separated by spaces in between values with the first row containing the name(s) of each column of data; it then auto-populates data columns in a list. There are a total of 3 lists that contain the same column titles, giving the user the ability to create x, y, and z plots in any way they wish.

_________________________________________________________________________________________________________________________________

INSTALLATION:
You can find all the necessary files for Hypermongo at my GitHub repository: https://github.com/IndigenousAlien/Hypermongo
