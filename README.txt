...
Hypermongo is an open-source data visualization tool designed to create plots for the SPH code (written by Gaburov, Lombardi & Portegies Zwart 2010) Starsmasher -- principally Starsmasher's energy#.sph and mass&More.out files. The purpose is to utilize Python's Matplot and PyQt packages which provides a wider range of tools while viewing data plots, compared to Robert Lupton and Patricia Monger's "Supermongo". 
